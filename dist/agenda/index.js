...
export default class AgendaView extends Component {
  ...
  generateMarkings() {
    ...
    return _extends({}, markings, { [key]: _extends({}, markings[key] || {}, { selected: true }) });
  }
  ...
  render() {
    ...
    let knob = React.createElement(View, { style: this.styles.knobContainer });

    if (!this.props.hideKnob) {
      const knobView = this.props.renderKnob ? this.props.renderKnob() : React.createElement(View, { style: this.styles.knob });
      knob = this.state.calendarScrollable ? null : React.createElement(
        View,
    ...
    return React.createElement(
      ...
      React.createElement(
        Animated.View,
        { style: weekdaysStyle },
        weekDaysNames.map(day => React.createElement(
          Text,
          { allowFontScaling: false, key: day, style: this.styles.weekday, numberOfLines: 1 },
          day
        ))
      ),
      React.createElement(
        ...
        React.createElement(View, { style: { height: agendaHeight + KNOB_HEIGHT }, onLayout: this.onScrollPadLayout })
      )
    );
  }
}
