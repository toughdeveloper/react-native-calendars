...
class CalendarList extends Component {
  ...
  renderCalendar({ item }) {
    return React.createElement(CalendarListItem, _extends({ item: item, calendarHeight: calendarHeight }, this.props));
  }
...
CalendarList.propTypes = _extends({}, Calendar.propTypes, {
